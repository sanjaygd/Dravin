...
quote_dict = { 'ACC':'ACC', 'Abbott India':'ABBOTINDIA', 'Adani Ports SEZ':'ADANIPORTS', 'Adani Transmission Ltd.':'ADANITRANS', 'Ambuja Cements':'AMBUJACEM', 
                'Asian Paints':'ASIANPAINT', 'Aurobindo Pharm':'AUROPHARMA', 'Axis Bank':'AXISBANK', 'BPCL':'BPCL', 'Bajaj Auto':'BAJAJ-AUTO', 
                ...
                'Infosys':'INFY', 'InterGlobe Aviation Ltd.':'INDIGO', 'JSW Steel':'JSWSTEEL', 'Kotak Bank':'KOTAKBANK', 'Larsen & Toubro':'LT', 
                ...
                'Petronet LNG':'PETRONET', 'Pidilite Ind':'PIDILITIND', 'Piramal Ent.':'PEL', 'PowerGrid':'POWERGRID', 'RIL':'RELIANCE', 'SBI':'SBIN', 'SBI Cards':'SBICARD', 
                ...
                'UltraTech Cem.':'ULTRACEMCO', 'United Brewerie':'UBL', 'Wipro':'WIPRO', 'Zee Ent.':'ZEEL'
